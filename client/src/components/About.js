...
const About = () => {
    return (
        <div className='container-md mx-5 my-5'>
            <h4 className =" p-3 mb-2 bg-primary text-white"> About US </h4>
